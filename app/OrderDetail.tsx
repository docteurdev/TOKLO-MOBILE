...
import { formatXOF, generateInvoiceNumber, Rs, SCREEN_W, SIZES } from '@/util/comon'
...
import { EDressStatus, IDress, IOrder, TInvoice } from '@/interfaces/type'
...
useEffect(() => {
   ...
   const invoice : TInvoice = {
        ...
        clientFullName: data?.client_name +" " + data?.client_lastname,
        clientPhone: data?.client_phone,
        invoiceNumber: generateInvoiceNumber(user?.id || 0, data?.updatedat || new Date().toLocaleDateString('fr-FR')),
